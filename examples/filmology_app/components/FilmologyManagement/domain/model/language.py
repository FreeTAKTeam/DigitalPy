...
class Language(Node):
    """"""
    def __init__(self, model_configuration, model, oid=None, node_type="Language") -> None:
    ...
    @shortForm.setter
    def shortForm(self, shortForm: 'str'):
        shortForm = str(shortForm)
        if not isinstance(shortForm, str):
            raise TypeError("'shortForm' must be of type str")
