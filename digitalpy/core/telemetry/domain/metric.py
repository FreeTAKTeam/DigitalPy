...
class Metric(Node):
    ...
    Attributes:
        ...
        value_expected (Optional[float]): The expected value of the metric.
    """

    def __init__(
        self, model_configuration, model, oid=None, node_type="Metric"
    ) -> None:
        """
        ...
        self._value_expected: Optional[float] = None
    ...
    @property
    def value_expected(self) -> Optional[float]:
        """The expected value of the metric."""
        return self._value_expected

    @value_expected.setter
    def value_expected(self, value_expected: Optional[float]):
        if value_expected is not None and not isinstance(value_expected, float):
            raise TypeError("'value_expected' must be of type float or None")
