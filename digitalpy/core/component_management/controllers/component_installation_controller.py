...
class ComponentInstallationController(Controller):
    ...
    def create_component_object(
        self, component_path: str, manifest_content: dict, import_root: str, config_loader
    ) -> "Component":
        """this method is used to create a component object from a manifest

        Args:
            manifest_content (dict): the manifest of the component
        ...
        #component = Component(model_configuration=None, model=None, oid=ObjectFactory.get_instance("ObjectID", {"id": str(uuid.uuid1()), "type": "Component"}), node_type="Component")
        component.author = str(manifest_content.get("author"))
        component.author_email = str(manifest_content.get("author_email"))
        component.description = str(manifest_content.get("description"))
        component.License = str(manifest_content.get("License"))
        component.repo = str(manifest_content.get("repo"))
        component.requiredAlfaVersion = str(manifest_content.get("requiredAlfaVersion"))
        component.URL = str(manifest_content.get("URL"))
        component.Version = str(manifest_content.get("Version"))
        component.UUID = str(manifest_content.get("UUID"))
        component.installation_path = component_path
        component.import_root = import_root
