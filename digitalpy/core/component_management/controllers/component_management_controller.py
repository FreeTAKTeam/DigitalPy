...
from digitalpy.core.component_management.domain.builder.actionkey_builder import ActionKeyBuilder
from digitalpy.core.component_management.domain.builder.error_builder import ErrorBuilder
from .component_management_persistence_controller_impl import Component_managementPersistenceControllerImpl
...
class Component_managementController(Controller):
    ...
    def __init__(self, request: 'Request',
        ...
        self.Actionkey_builder = ActionKeyBuilder(request, response, sync_action_mapper, configuration)
        self.Error_builder = ErrorBuilder(request, response, sync_action_mapper, configuration)
        self.component_management_persistence_controller_impl = Component_managementPersistenceControllerImpl(
    ...
    def initialize(self, request: 'Request', response: 'Response'):
        ...
        self.component_management_persistence_controller_impl.initialize(request, response)
        return super().initialize(request, response)
    def POSTComponentRequiredAlfaVersion(self, system_installedAlfaVersion: 'float', body: 'Component', client: 'NetworkClient', config_loader, *args, **kwargs): # pylint: disable=unused-argument
        """"""
        return None

    def DELETEComponent(self, ID: str, client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
        """TODO"""
        db_records = self.component_management_persistence_controller_impl.get_component(ID = ID)
        ...
        for record in db_records:
            ...
            self.component_management_persistence_controller_impl.remove_component(record)
    ...
    def GETComponent(self, client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
        ...
        db_records = self.component_management_persistence_controller_impl.get_all_component()
        domain_records: List['Component'] = []
    ...
    def PATCHComponent(self, body: 'Component',  client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
        ...
        db_obj = self.component_management_persistence_controller_impl.get_component(oid=str(domain_obj.oid))[0]
        ...
        self.component_management_persistence_controller_impl.update_component(domain_obj)
    ...
    def POSTActionKey(self, body: 'str', client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
        """TODO"""

        # initialize Actionkey builder
        self.Actionkey_builder.build_empty_object(config_loader=config_loader)
        self.Actionkey_builder.add_object_data(mapped_object = body, protocol=Protocols.JSON)
    ...
    def DELETEActionKey(self, ID: str, client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
        """TODO"""
        db_records = self.component_management_persistence_controller_impl.get_actionkey(ID = ID)
        ...
        for record in db_records:
            ...
            self.component_management_persistence_controller_impl.remove_actionkey(record)
            domain_records.append(record)
        # set the target
        self.response.set_value("recipients", [str(client.get_oid())])
    ...
    def GETActionKey(self, client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
        """TODO"""
        # retrieve the Actionkey record from the database
        db_records = self.component_management_persistence_controller_impl.get_all_actionkey()
        domain_records: List['ActionKey'] = []
    ...
    def PATCHActionKey(self, body: 'ActionKey',  client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
        """TODO"""
        # create the basic domain object from the json data
        ...
        # get from the database
        db_obj = self.component_management_persistence_controller_impl.get_actionkey(oid=str(domain_obj.oid))[0]
        ...
        self.Actionkey_builder.add_object_data(body, Protocols.JSON)
        # Save the Schedule record to the database
        self.component_management_persistence_controller_impl.update_actionkey(domain_obj)
    ...
    def GETComponentRegister(self, ID: 'str', client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
    ...
    def GETComponentDiscovery(self, client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
        """TODO"""
        # retrieve the Component record from the database
        db_records = self.component_management_persistence_controller_impl.get_all_component()
        domain_records: List['Component'] = []
    ...
    def GETActionKeyId(self, ID: 'str', client: 'NetworkClient', config_loader, *args, **kwargs):  # pylint: disable=unused-argument
        """TODO"""
