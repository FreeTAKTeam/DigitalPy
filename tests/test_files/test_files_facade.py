...
def test_get_or_create_file_creates_new_file(
    files_facade: Files, temp_dir: tempfile.TemporaryDirectory
):
...
def test_get_or_create_file_returns_existing_file(
    files_facade: Files, temp_dir: tempfile.TemporaryDirectory
):
...
def test_create_file_creates_new_file(
    files_facade: Files, temp_dir: tempfile.TemporaryDirectory
):
...
def test_get_file_raises_error_when_not_exists(
    files_facade: Files, temp_dir: tempfile.TemporaryDirectory
):
